 ...
 */
#include <jni.h>
#include "org_commoncrawl_util_GoogleURL.h"
...
extern "C"  void JNICALL Java_org_commoncrawl_util_GoogleURL_internal_1init(JNIEnv* env, jclass googleURLClazz,jclass googleURLComponentClazz) { 
...
extern "C" void JNICALL Java_org_commoncrawl_util_GoogleURL_initializeFromURL(JNIEnv * env, jobject thisObj, jstring urlString) { 
