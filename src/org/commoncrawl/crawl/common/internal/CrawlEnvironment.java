...
/**
 * 
 * Crawl specific global constants
 * 
 * @author rana
 *
 */
public final class CrawlEnvironment extends Environment {
  ...
  public static final Text   CrawlURLMetadataKey = new Text(MetaData_CrawlURLMetadata);
  ...
  public static final String HDFS_CrawlDBDirectory           =   HDFS_CrawlDBBaseDir + "/" + "crawldb";
  public static final String HDFS_CrawlSegmentsDirectory = HDFS_CrawlDBBaseDir + "/" + "crawl_segments";
  public static final String HDFS_ParseCandidateSegmentsDirectory = HDFS_CrawlDBBaseDir + "/" + "parse_segments";
  public static final String HDFS_CheckpointDataDirectory       = HDFS_CrawlDBBaseDir + "/" + "checkpoint_data";
  public static final String HDFS_CheckpointStagingDirectory       = HDFS_CrawlDBBaseDir + "/" + "checkpoint_staging";
  public static final String HDFS_RobotsDBDirectory              = HDFS_CrawlDBBaseDir + "/robotsDB";
  
  public static final String HDFS_StatsDirectory = HDFS_CrawlDBBaseDir + "/" + "stats";
  ...
  public static final int CONTENT_SIZE_LIMIT = 2 << 18; // 524288
  ...
  public static FileSystem getDefaultFileSystem() throws IOException { 
    // if an override was not specified... get the default file system via hadoop-site.xml
    if (getDefaultHadoopFSURI() == null) { 
      return FileSystem.get(getHadoopConfig());
    }
    // otherwise ... 
    else {
      return FileSystem.get(URI.create(getDefaultHadoopFSURI()), getHadoopConfig());
    }
  }
  ...
  public static String buildCrawlLogCheckpointName(String nodeName,long checkpointId) { 
  ...
  public static String buildCrawlSegmentLogCheckpointFileName(String nodeName, long checkpointId) { 
  ...
  public static String buildCrawlSegmentLogCheckpointWildcardString(String nodeName) { 
