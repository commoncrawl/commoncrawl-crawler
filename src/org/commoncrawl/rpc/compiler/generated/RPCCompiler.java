...
public class RPCCompiler implements RPCCompilerConstants {
  ...
  final public JFile Input() throws ParseException {
    ...
    jj_consume_token(0);
      {if (true) return new JFile(curFileName, ilist, rlist,serviceList);}
  ...
  final public JMethod Method() throws ParseException {
    ...
    jj_consume_token(RPAREN_TKN);
        ...
        {if (true) return new JMethod(name.image,inputRecordType,outputRecordType);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String RecordModifier() throws ParseException {
    ...
    modifier = jj_consume_token(IDENT_TKN);
                {if (true) return modifier.toString();}
    throw new Error("Missing return statement in function");
  }
  ...
  final public JComparator Comparator() throws ParseException {
    ...
    jj_consume_token(RBRACE_TKN);
                {if (true) return new JComparator(name.toString(),fieldNames);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public JEnum Enumeration() throws ParseException {
    ...
    jj_consume_token(RBRACE_TKN);
                {if (true) return new JEnum(name.image,values);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public JEnumValue EnumerationValue() throws ParseException {
    ...
    jj_consume_token(SEMICOLON_TKN);
          {if (true) return new JEnumValue(valueName.image,Integer.parseInt(ordinal.image));}
    throw new Error("Missing return statement in function");
  }
  ...
  final public JField<JType> Field() throws ParseException {
    ...
    jj_consume_token(EQUALS_TKN);
    ordinal = jj_consume_token(INTEGER_TKN);
      {if (true) return new JField<JType>(name.image, jt,Integer.parseInt(ordinal.image),modifiers);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public JType Type() throws ParseException {
    ...
    case INT_TKN:
      ...
      {if (true) return new JInt(false);}
      break;
    case LONG_TKN:
      jj_consume_token(LONG_TKN);
      {if (true) return new JLong(false);}
      break;
    case VINT_TKN:
      jj_consume_token(VINT_TKN);
      {if (true) return new JInt(true);}
      break;
    case VLONG_TKN:
      jj_consume_token(VLONG_TKN);
      {if (true) return new JLong(true);}
      break;
    case FLOAT_TKN:
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x80800,0x80800,0x3000,0x3000,0x0,0x4000,0x0,0x0,0x0,0x0,0xfff18000,0xfff18000,0xfff00000,0x0,0x0,0x0,0x0,0x0,0xfff00000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x800,0x0,0x2008,0x2008,0x400,0x8000,0xa000,0xa000,0xa000,0x2000,0x2000,0x400,0x3,0x8000,0x2000,};
   }
