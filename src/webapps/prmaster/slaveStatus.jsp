...
<TABLE width=100% BORDER=1>
	<TR><TD><B>Slave ID</B><TD WIDTH=100%><B>Status</B></TR>
	<%
	for (PageRankRemoteSlave slave : server.getSlaves()) { 
	%>
	<TR><TD><%=slave.getFullyQualifiedName()%><TD><%=slave.getStatusText()%></TR>
	<%
	}
	%>
</TABLE>
